...
export default function Header() {
    return (
        <div className="lg:h-fit pl-6 bg-blue rounded-b-3xl">
            <div className="grid lg:grid-cols-2 grid-cols-1 gap-6">
                <div className="lg:pt-24 md:pt-36 pt-96">
                    ...
                    <div className="mt-6">
                        <button
                            type="button"
                            className="flex justify-start bg-[#FFA62B] text-white font-bold hover:bg-[#FF8C1A] focus:outline-none px-5 py-3 rounded-full"
                        >
                            <Link to="/login">
                                Get Started
                            </Link>
