// src/admin/library/SearchBar.js
        ...
        <div className='flex flex-col items-center p-4'>
            <div className='flex w-full px-24 py-4'>
                <input
                    ...
                    value={searchTerm} // nilai input sesuai dengan searchTerm dari parent
                    onChange={onSearchChange} // memanggil handler dari parent ketika input berubah
                />
